...
int main(int argc, char *argv[])
{
  ...
  QPixmap myPixmap(":/zino_logo.png");
  QSplashScreen *mypSplash = new QSplashScreen(myPixmap);
  QPixmap myMaskPixmap(":/zino_logo_mask.png", 0, Qt::ThresholdDither |   Qt::ThresholdAlphaDither | Qt::AvoidDither );
  ...
  QCoreApplication::setOrganizationDomain("zino.linfiniti.com");
  QCoreApplication::setApplicationName("Zino");
  ...
  Zino * mypZino = new Zino();
  mypZino->show();
  mypSplash->finish(mypZino);
  delete mypSplash;
